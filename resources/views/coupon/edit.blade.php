...
<div class="container">
    ...
    <img src="data:image/png;base64,{{ DNS1D::getBarcodePNG($coupon->code, 'C39+',1,50) }}" alt="barcode"   />
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row ">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="post" enctype="multipart/form-data" action="{{url('/coupon/update')}}" > 
                        {{csrf_field()}}
