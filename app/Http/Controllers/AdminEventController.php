...
class AdminEventController extends Controller
{
    public function index()
    {
        ...
        return view("admin.event.index", ["event_info" => $EventInfo]);
    }
    ...
    public function edit($event_id)
    {
        ...
        return view('admin.event.edit', ["event" => $EventInfo, "event_id" => $event_id]);
    ...
    public function link($event_id)
    {
        ...
        return view("admin.event.link", ["vendors" => $vendors, 'event' => $event, 'event_id' => $event_id]);
    }
    ...
    public function change($event_id)
    {
        ...
        return view("admin.event.link", ["vendors" => $vendors, 'event' => $event, 'event_id' => $event_id, 'vendor_id' => $vendor_id]);
    }
